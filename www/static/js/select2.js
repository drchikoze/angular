    ...
    AbstractSelect2 = clazz(Object, {
        ...
        positionDropdown: function() {
            var $dropdown = this.dropdown,
                offset = this.container.closest('.ls-form-select').offset(),
                height = this.container.outerHeight(false),
                width = this.container.closest('.ls-form-select').outerWidth(false),
                ...
                dropTop = offset.top + height - 6,
                dropLeft = offset.left - 5,
