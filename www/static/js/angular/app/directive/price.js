angular.module('filters').directive('priceLocal', ['$rootScope', 'templateLoader',  'dataSource', function($rootScope, templateLoader, $dataSource) {
            ...
            this.updateFilterStatus = function(items) {
                ...
                if ($scope.total_selected > 0) {
                    ...
                    if ($scope.total_selected == 1) {
                        ...
                        valueString += $scope.total_selected.toString();
                        if ($attrs['selected'])
